...
class PaperArgumentGraphBuilder:
    ...
    def _facet_for_role(role: str) -> str:
        return {
            ...
            "method": "how",
            "method_overview": "how",
            "method_component": "how",
            "algorithm": "how",
            "implementation_detail": "how",
            "training_strategy": "how",
            "inference_strategy": "how",
            "equation": "how",
            "figure": "how",
            "extension": "how",
            "table": "proof",
            "experimental_setup": "proof",
            "dataset": "proof",
            "metric": "proof",
            "baseline": "proof",
            "experiment": "proof",
            "ablation": "proof",
            "result": "proof",
            "qualitative_result": "proof",
            "efficiency_analysis": "proof",
            "conclusion": "proof",
        }.get(role, "why")
    ...
    def _node_type_for_role(role: str) -> NodeType:
        return {
            ...
            "background": NodeType.TEXT_BLOCK,
            "prior_work": NodeType.PRIOR_WORK,
            "definition": NodeType.DEFINITION,
            "observation": NodeType.OBSERVATION,
            "design_rationale": NodeType.DESIGN_RATIONALE,
            "method": NodeType.METHOD,
            "method_overview": NodeType.METHOD,
            "method_component": NodeType.MODULE,
            "algorithm": NodeType.ALGORITHM,
            "implementation_detail": NodeType.IMPLEMENTATION,
            "training_strategy": NodeType.TRAINING,
            "inference_strategy": NodeType.INFERENCE,
            "experiment": NodeType.EXPERIMENT,
            "experimental_setup": NodeType.EXPERIMENT,
            "dataset": NodeType.DATASET,
            "metric": NodeType.METRIC,
            "baseline": NodeType.BASELINE,
            "ablation": NodeType.ABLATION,
            "result": NodeType.RESULT,
            "qualitative_result": NodeType.QUALITATIVE_RESULT,
            "efficiency_analysis": NodeType.EFFICIENCY,
    ...
    def _edge_type_for_role(role: str) -> EdgeType:
        return {
            "claim": EdgeType.JUSTIFIES,
            "motivation": EdgeType.MOTIVATES,
            "gap": EdgeType.MOTIVATES,
            "problem": EdgeType.MOTIVATES,
            "prior_work": EdgeType.BUILDS_ON,
            "definition": EdgeType.DEFINES,
            "observation": EdgeType.JUSTIFIES,
            "design_rationale": EdgeType.JUSTIFIES,
            "method": EdgeType.IMPLEMENTED_BY,
            "method_overview": EdgeType.IMPLEMENTED_BY,
            "method_component": EdgeType.HAS_MODULE,
            "algorithm": EdgeType.DESCRIBES,
            "implementation_detail": EdgeType.DESCRIBES,
            "training_strategy": EdgeType.DESCRIBES,
            "inference_strategy": EdgeType.DESCRIBES,
            "experiment": EdgeType.VALIDATES,
            "experimental_setup": EdgeType.DESCRIBES,
            "dataset": EdgeType.DESCRIBES,
            "metric": EdgeType.DEFINES,
            "baseline": EdgeType.CONTRASTS_WITH,
            "ablation": EdgeType.VALIDATES,
            "result": EdgeType.SUPPORTED_BY,
            "qualitative_result": EdgeType.SUPPORTED_BY,
            "efficiency_analysis": EdgeType.SUPPORTED_BY,
            "extension": EdgeType.EXTENDS,
